sap.ui.define([
    ...
    return PropertyEditor.extend( "{{namespace}}.{{pluginname}}.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("{{namespace}}.{{pluginname}}.i18n.builder");
			this.setPluginResourceBundleName("{{namespace}}.{{pluginname}}.i18n.i18n");
		},
